...
| R-CLOUD-01 | critical | Cloud creation causes uncontrolled cost or exposure | zero-resource default, exact confirmation, independent approvals, four-hour cost envelope, named stop owner, verified live budget/state controls and 2026-07-24 pricing review | owner redundancy, exact resource-bearing plan approval and runtime stop discipline |
