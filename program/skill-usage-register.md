...
| PRG-CTX7-001 | Enable the Context7 evidence workflow | Context7 CLI via npx | CLI fallback activated without requiring a standalone executable. Nine libraries were resolved and queried; task-specific evidence remains mandatory. | Node v26.5.0 runtime; PostgreSQL/RLS; OpenAPI 3.1.1; JSON Schema object validation; Ajv validation; Docker; pgvector; ClamAV scanning; PDF.js | Versioned records and implementation decisions in program/context7-evidence.md | npx ctx7 v0.5.5, MIT, github.com/upstash/context7; current records include /docker/docs, /pgvector/pgvector, /cisco-talos/clamav, and /mozilla/pdf.js. | completed |
...
- resolved libraries: /nodejs/node, /websites/postgresql_current, /oai/openapi-specification/3.1.1, /websites/json-schema_understanding-json-schema, /ajv-validator/ajv/v8.17.1, /docker/docs, /pgvector/pgvector, /cisco-talos/clamav, /mozilla/pdf.js
