...
export const municipalAntiguaDomainPack: DomainPack = {
  ...
  workflowTypes: [
    { id: "potable_water_project", label: "Agua potable comunitaria", description: "Investigación documental y seguimiento de un proyecto de agua potable para una comunidad.", retrievalHints: [
      "\"agua potable\" OR diagnóstico OR caudal OR \"calidad del agua\" OR topografía OR hidráulico",
      "PDM-OT OR POM OR POA OR presupuesto OR financiamiento OR \"inversión pública\" OR ambiente",
      "contratación OR ofertas OR adjudicación OR contrato OR supervisión OR recepción OR liquidación",
      "operación OR mantenimiento OR continuidad OR \"calidad del servicio\"",
    ] },
