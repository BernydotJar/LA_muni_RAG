...
Los kits portables para consumidores están documentados en [Kits portables de contratos](./consumer-contract-kits.md) y se verifican con `npm run contracts:consumer-verify`. Esta verificación es provider-side y no sustituye las pruebas en los repositorios consumidores.
