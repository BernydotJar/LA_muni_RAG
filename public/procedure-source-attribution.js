(function () {
  ...
  const fallbackAttribution = (step) => {
    ...
    return {
      status: primary.authorityLevel === "comparative" ? "comparative" : primary.authorityLevel === "context" ? "contextual" : primary.authorityLevel === "national" ? "official_national" : primary.authorityLevel === "primary" ? "official_municipal" : "insufficient",
