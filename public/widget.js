...
(function () {
  ...
  const CSS = `
    ...
    :host([data-theme="light"]) {
      ...
      --muni-surface-soft: rgba(226, 232, 240, 0.72);
    ...
    .muni-bubble {
      ...
      border-radius: 24px;
      background:
        radial-gradient(circle at 30% 18%, rgba(255,255,255,0.62), transparent 18%),
        linear-gradient(135deg, #6d5df6, #8b5cf6 56%, #22d3ee);
    ...
    .muni-bubble::before {
      ...
      position: absolute;
      inset: -45%;
      background: conic-gradient(from 20deg, transparent, rgba(34,211,238,0.55), transparent, rgba(244,114,182,0.42), transparent);
      animation: muni-orbit 8s linear infinite;
      opacity: 0.72;
    }
    ...
    .muni-bubble::after {
      ...
      inset: 3px;
      border-radius: 21px;
      background: linear-gradient(135deg, rgba(124,92,255,0.92), rgba(88,80,236,0.92));
    }

    .muni-bubble:hover {
      transform: translateY(-4px) scale(1.035);
      box-shadow: 0 26px 76px rgba(109, 93, 246, 0.56), 0 0 0 10px rgba(34,211,238,0.10);
    }

    .muni-bubble:active { transform: scale(0.96); }
    ...
    .muni-bubble .muni-pulse { display: none; }

    @keyframes muni-orbit {
    ...
    .muni-window {
      ...
      min-height: 520px;
      background:
        radial-gradient(circle at 18% 0%, rgba(34,211,238,0.20), transparent 30%),
        radial-gradient(circle at 92% 18%, rgba(139,92,246,0.22), transparent 34%),
    ...
    .muni-window::after {
      ...
      top: 0;
      height: 1px;
      background: linear-gradient(90deg, transparent, rgba(34,211,238,0.68), rgba(244,114,182,0.56), transparent);
      pointer-events: none;
    }
    ...
    .muni-header {
      ...
      background: linear-gradient(135deg, rgba(124,92,255,0.20), rgba(34,211,238,0.08) 50%, rgba(244,114,182,0.08));
    ...
    .muni-header-icon {
      ...
      border-radius: 18px;
      background:
        radial-gradient(circle at 32% 20%, rgba(255,255,255,0.52), transparent 20%),
        linear-gradient(135deg, #6d5df6, #8b5cf6 56%, #22d3ee);
      display: flex;
      align-items: center;
      justify-content: center;
      ...
      box-shadow: 0 16px 36px rgba(109,93,246,0.28);
    }
    ...
    .muni-messages {
      ...
      background: linear-gradient(180deg, rgba(5,7,22,0.18), rgba(5,7,22,0.34));
    }
    ...
    .muni-messages::-webkit-scrollbar-thumb {
      background: linear-gradient(180deg, rgba(124,92,255,0.74), rgba(34,211,238,0.34));
      border-radius: 999px;
      border: 2px solid rgba(5,7,22,0.4);
    }

    .muni-msg {
      max-width: 92%;
      animation: muni-msgIn 0.32s cubic-bezier(0.34, 1.56, 0.64, 1);
    }
    ...
    .muni-msg-assistant { align-self: flex-start; width: min(100%, 380px); }

    .muni-msg-user .muni-msg-bubble {
      background: var(--muni-user);
      color: white;
      border-radius: 20px 20px 6px 20px;
      padding: 12px 16px;
      box-shadow: 0 16px 36px rgba(109,93,246,0.24);
      font-weight: 680;
    ...
    .muni-msg-assistant .muni-msg-bubble {
      ...
      background:
        ...
        var(--muni-message);
      border: 1px solid var(--muni-border-strong);
      border-radius: 22px 22px 22px 8px;
      padding: 16px;
      box-shadow: 0 18px 46px rgba(0,0,0,0.20), inset 0 1px 0 rgba(255,255,255,0.08);
      overflow: hidden;
    }

    .muni-msg-assistant .muni-msg-bubble::before {
      content: "";
      position: absolute;
      inset: 0 auto 0 0;
      width: 3px;
      background: linear-gradient(180deg, var(--muni-cyan), var(--muni-primary), var(--muni-magenta));
      opacity: 0.9;
    }
    ...
    .muni-answer-kicker::before {
      content: "";
      width: 7px;
      height: 7px;
      border-radius: 999px;
      background: var(--muni-cyan);
      box-shadow: 0 0 14px rgba(34,211,238,0.86);
    }

    .muni-answer-content p,
    .muni-msg-bubble p {
      margin: 0 0 10px;
    }

    .muni-answer-content p:last-child,
    .muni-msg-bubble p:last-child { margin-bottom: 0; }

    .muni-msg-bubble strong { color: var(--muni-primary-hover); font-weight: 820; }
    ...
    .muni-citation {
      position: relative;
      background:
        linear-gradient(180deg, rgba(124,92,255,0.12), rgba(34,211,238,0.05)),
        rgba(8, 13, 34, 0.72);
    ...
    .muni-citation-excerpt {
      ...
      border-left: 3px solid var(--muni-cyan);
    }
    ...
    .muni-meta-tag.confidence-high { border-color: rgba(34,197,94,0.45); color: #86efac; }
    .muni-meta-tag.confidence-medium { border-color: rgba(245,158,11,0.45); color: #fcd34d; }
    .muni-meta-tag.confidence-low { border-color: rgba(248,113,113,0.45); color: #fca5a5; }
    ...
    .muni-input:focus {
      ...
      box-shadow: 0 0 0 4px rgba(34,211,238,0.08), inset 0 1px 0 rgba(255,255,255,0.08);
      background: rgba(18, 28, 64, 0.96);
    }
    ...
    .muni-send {
      ...
      height: 46px;
      border-radius: 16px;
      background: linear-gradient(135deg, #8b5cf6, #6d5df6 58%, #22d3ee);
    ...
    .muni-welcome-icon {
      ...
      height: 54px;
      border-radius: 18px;
      background: linear-gradient(135deg, #6d5df6, #8b5cf6 58%, #22d3ee);
      display: flex;
      align-items: center;
      justify-content: center;
      margin-bottom: 16px;
      box-shadow: 0 18px 42px rgba(109,93,246,0.26);
    }
  ...
  class MuniChatWidget {
      ...
      this.container.innerHTML = `
        <div class="muni-window" id="muni-window">
          <div class="muni-header">
            ...
            <div class="muni-header-rail" aria-hidden="true">
              <span class="muni-rail-pill">Evidencia</span>
              <span class="muni-rail-pill">Citas</span>
              <span class="muni-rail-pill">Sin caja negra</span>
            </div>
          </div>
          <div class="muni-messages" id="muni-messages">
            <div class="muni-welcome">
              <div class="muni-welcome-icon">${ICONS.building}</div>
              <h3>Consulta municipal con evidencia</h3>
              <p>Haz preguntas sobre documentos municipales de La Antigua Guatemala. Las respuestas deben apoyarse en fuentes verificables o indicar falta de evidencia suficiente.</p>
              <div class="muni-suggestions">
                <button class="muni-suggestion" data-query="ordenamiento territorial">Plan Municipal · Ordenamiento territorial</button>
                <button class="muni-suggestion" data-query="CNPAG">Patrimonio · ¿Qué es el CNPAG?</button>
                <button class="muni-suggestion" data-query="necesidades locales">Diagnóstico · Necesidades locales</button>
              </div>
            </div>
          </div>
          ...
          <div class="muni-input-area">
            <textarea class="muni-input" id="muni-input" placeholder="Escribe tu consulta municipal..." rows="1" aria-label="Mensaje"></textarea>
            <button class="muni-send" id="muni-send" aria-label="Enviar mensaje">${ICONS.send}</button>
          </div>
    ...
    open() {
      this.isOpen = true;
      const win = this.shadow.getElementById("muni-window");
      const bubble = this.shadow.getElementById("muni-bubble");
      win.classList.add("visible");
      bubble.classList.add("open");
      bubble.innerHTML = ICONS.close;
      setTimeout(() => this.shadow.getElementById("muni-input")?.focus(), 300);
    }
    ...
    addMessage(role, content) {
      ...
      if (role === "user") {
        ...
        bubble.innerHTML = `<span class="muni-answer-kicker">Respuesta con evidencia</span><div class="muni-answer-content"><p>${renderMarkdown(content)}</p></div>`;
      }
    ...
    addAssistantMessage(data) {
      ...
      const bubble = document.createElement("div");
      bubble.className = "muni-msg-bubble";
      bubble.innerHTML = `<span class="muni-answer-kicker">Respuesta con evidencia</span><div class="muni-answer-content"><p>${renderMarkdown(data.content || "")}</p></div>`;
        ...
        data.citations.forEach((citation, index) => {
          ...
          card.innerHTML = `
            <div class="muni-citation-header">
              ...
              <span class="muni-citation-index">Evidencia ${index + 1}</span>
            </div>
            <span class="muni-citation-label">${this.escapeHtml(citationLabel)}</span>
            <div class="muni-citation-excerpt" data-excerpt-full="${this.escapeHtml(fullExcerpt)}" data-excerpt-preview="${this.escapeHtml(preview)}">${this.escapeHtml(preview)}</div>
          `;

          const toggleCard = () => {
            card.classList.toggle("expanded");
            const excerptEl = card.querySelector(".muni-citation-excerpt");
            excerptEl.textContent = card.classList.contains("expanded")
              ? excerptEl.getAttribute("data-excerpt-full")
              : excerptEl.getAttribute("data-excerpt-preview");
            this.scrollToBottom();
          };
      ...
      if (data.meta) {
        ...
        const evidenceCount = data.meta.evidenceCount || 0;
        metaDiv.innerHTML = `
          <span class="muni-meta-tag confidence-${this.escapeHtml(confidence)}">Confianza ${confidenceLabel}</span>
          <span class="muni-meta-tag">${this.escapeHtml(evidenceCount)} fuente${evidenceCount !== 1 ? "s" : ""}</span>
        `;
    ...
    showTyping() {
      ...
      typing.innerHTML = `
        <span class="muni-typing-label">Consultando evidencia</span>
        <span class="muni-typing-dots"><span class="muni-typing-dot"></span><span class="muni-typing-dot"></span><span class="muni-typing-dot"></span></span>
      `;
