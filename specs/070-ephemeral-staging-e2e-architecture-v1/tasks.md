...
- [x] Write RED staging-plan tests.
- [x] Add closed schema and canonical manifest.
- [x] Implement semantic verifier and deterministic execution summary.
- [x] Enforce exact RBAC, OpenAPI, tenant isolation, reset coverage, mock boundaries, and secret guards.
